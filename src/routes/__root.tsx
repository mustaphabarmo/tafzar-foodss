  ...
  head: () => ({
    meta: [
      ...
      { title: "Tafzar Spin — Spin & Win with Tafzar Foods" },
      {
        name: "description",
        content:
          "Spin the Tafzar Foods prize wheel and instantly win discounts, free treats and rewards.",
      },
      { name: "author", content: "Tafzar Foods" },
      { property: "og:title", content: "Tafzar Spin — Spin & Win with Tafzar Foods" },
      {
        property: "og:description",
        content: "Spin the Tafzar Foods prize wheel and win discounts, free treats and rewards.",
      },
